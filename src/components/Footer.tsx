...
const Footer = () => {
    return (
        <footer className="bg-white border-t border-gray-400 shadow mt-auto">
                    ...
                    <div className="flex w-full md:w-1/2">
                        <div className="px-8">
                            ...
                            <ul className="list-reset items-center text-sm pt-3">
                                <li>
                                    <a className="inline-block text-gray-600 no-underline hover:text-gray-900 hover:underline py-1"
